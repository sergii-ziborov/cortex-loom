...
pub(crate) const MAX_FACET_EXPANSIONS: u32 = 4;
/// Stop when the remaining compile budget cannot carry another atom.
pub(crate) const MIN_REMAINING_TOKENS: u32 = 400;

#[must_use]
pub(crate) fn remaining_tokens(bundle: &EvidenceBundle, budget: u32) -> u32 {
    let used = bundle
        .evidence
        .iter()
...
#[must_use]
pub(crate) fn expansion_targets(key: &str, all_missing: &[String]) -> Vec<String> {
...
#[must_use]
pub(crate) fn expansion_key(missing: &str) -> String {
...
#[must_use]
pub(crate) fn next_gather_expansion(missing: &[String], tried: &[String]) -> Option<String> {
