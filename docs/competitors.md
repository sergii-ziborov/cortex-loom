...
| engineering methodology | Superpowers | 14 mandatory prose skills covering TDD, debugging, planning, worktrees, review and parallel execution | Cortex rewrote 13 of those *mechanics* as seven typed editable sequences (not a 1:1 skill port) and skipped the global `using-superpowers` bootstrap |
